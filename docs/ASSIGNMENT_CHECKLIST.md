...
เอกสารนี้เทียบข้อกำหนดจากไฟล์ **Project 1: Socket Programming** กับหลักฐานใน DART โดยแยกสิ่งที่มีใน repo แล้วออกจากงานส่งที่ผู้จัดทำต้องทำเอง
...
| ส่ง source code | public repository นี้รวม implementation, 86 tests, README, docs, Wireshark และ measured results; ใช้ GitHub URL, tagged revision หรือ archive ที่ GitHub สร้างจาก commit ที่ส่ง | **พร้อม:** อัปโหลดตามช่องทางวิชาและบันทึก commit/tag ที่ใช้ส่ง |
| นำเสนอ protocol ด้วย PPT แล้วอธิบาย code | [DART_Presentation.pptx](../submission/DART_Presentation.pptx) 15 slides พร้อม speaker notes และ [VIDEO_SCRIPT](../submission/VIDEO_SCRIPT.md) | **พร้อม:** ตรวจข้อมูลผู้จัดทำและบรรยายเอง |
| Demo และทดสอบหลายรูปแบบ | `demo.py`, `benchmark.py`, `tests/`, loss/ACK-loss/corruption/strict-envelope cases และ Wireshark | **พร้อมสำหรับอัด** |
...
| บอกจุดเด่น ต่างจากสิ่งที่มี และนำไปใช้อะไร | [DEMO_GUIDE](DEMO_GUIDE.md) ช่วง 10:30 และ limitations; อธิบายอย่างไม่อ้าง global novelty |
| ถ้าอ้าง performance ต้องบอกว่าดีกว่าอย่างไรและวัดอย่างไร | `benchmark.py`, [results/README](../results/README.md), fixed workload fingerprint, acceptance/confirmation, bytes, P95, final latest state; ระบุว่าเป็น controlled loopback/application-loss experiment และรายงาน seed/repeats/sample counts |
